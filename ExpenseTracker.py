...
dataentery_frame_bg = 'lemon chiffon'
buttons_frame_bg = 'gray7'
hlb_btn_bg = 'light goldenrod'
...
root = Tk()
root.title('XPASS Expense Tracker')
...
# Buttons' Frame
Button(buttons_frame, text='Delete Expense', font=btn_font, width=25, bg=hlb_btn_bg, command=remove_expenses).place(x=30, y=5)
